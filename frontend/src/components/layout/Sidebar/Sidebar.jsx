...
import { RiDashboardLine, RiGroupLine, RiFileList3Line, RiUploadCloud2Line, RiTrophyLine, RiInformationLine, RiSettings4Line, RiLogoutBoxRLine } from 'react-icons/ri'
...
function SchoolLogo() {
    return (
        <svg viewBox="0 0 100 100" width="18" height="18" xmlns="http://www.w3.org/2000/svg">
            <rect x="10" y="40" width="80" height="55" rx="4" fill="none" stroke="#fff" strokeWidth="5" />
            <path d="M50 10 L92 40 L8 40 Z" fill="none" stroke="#fff" strokeWidth="5" strokeLinejoin="round" />
            <rect x="36" y="58" width="28" height="37" rx="3" fill="none" stroke="#fff" strokeWidth="4" />
            <rect x="18" y="52" width="18" height="16" rx="2" fill="none" stroke="#fff" strokeWidth="4" />
            <rect x="64" y="52" width="18" height="16" rx="2" fill="none" stroke="#fff" strokeWidth="4" />
            <line x1="50" y1="10" x2="50" y2="2" stroke="#fff" strokeWidth="4" strokeLinecap="round" />
            <line x1="44" y1="5" x2="56" y2="5" stroke="#fff" strokeWidth="4" strokeLinecap="round" />
        </svg>
    )
}

function Sidebar({ role = 'admin', user = {}, activePath = '' }) {
